...
extension LocaleExtension on Locale {
  /// Returns the display name in native for the locale's language.
  String getDisplayLanguage() {
    if (languageNames.containsKey(languageCode)) {
      return languageNames[languageCode]!['nativeName']!;
    } else {
      throw Exception(
          'The language code $languageCode is not in the languageNames map.');
    }
  }
}
